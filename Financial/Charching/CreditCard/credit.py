...
def update_message_credit(event, ack, body, logger, client):
    ack()
    event = body["message"]
...
def handle_credit_action(event, ack, body, logger, client):
    ack()
    ...
    update_message_credit(event, ack, body, logger, client)
