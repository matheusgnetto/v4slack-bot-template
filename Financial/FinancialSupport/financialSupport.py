...
def update_message_financial_support(event, ack, body, logger, client):
    ack()
    event = body["message"]
...
def handle_financial_support(event, ack, body, logger, client):
    ack()
    ...
    update_message_financial_support(event, ack, body, logger, client)
