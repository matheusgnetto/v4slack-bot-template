...
def update_message_leadership(event, ack, logger, body, client):
    ack()
    event = body["message"]
        ...
        result = client.chat_update(channel=channel_id,
                                    ...
                                    blocks=[{"type": "actions",
                                            ...
                                            {"type": "actions",
                                             ...
                                             "elements": [{"type": "button",
                                                           "text": {"type": "plain_text",
                                                                    "text": "Link de Inscriçao"},
                                                           "style": "danger",
                                                           "url": "URL",
                                                           "action_id": "leadership_sub",
                                                           },
                                                          {"type": "button",
                                                           "text": {"type": "plain_text",
                                                                    "text": "Indicar um Cliente"},
                                                           "style": "danger",
                                                           "url": "URL",
                                                           "action_id": "leadership_customer",
                                                           },
                                                          ]}],
                                    thread_ts=thread_ts)
        logger.info(result)
