...
def update_message_investorproblem_support(event, ack, body, logger, client):
    ack()
    event = body["message"]
...
def handle_investorproblem_support(event, ack, body, logger, client):
    ack()
    ...
    update_message_investorproblem_support(event, ack, body, logger, client)
